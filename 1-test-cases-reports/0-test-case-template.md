...
### Objective:
To verify that the balance sheet data in OneStream matches SAP for the reporting period **01 Jan 2021 to 31 Jul 2021** across **5 APAC countries**.

### Test Steps:
1. Extract balance sheet data from SAP for the period **01 Jan 2021 to 31 Jul 2021**.

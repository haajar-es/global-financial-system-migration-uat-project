...
## Objective:
Ensure that the P&L report for **July 2021** in **OneStream** matches the financial data in **SAP** across 5 APAC countries.

### Test Steps:
1. Extract P&L data from SAP for the period **01 July 2021 - 31 July 2021**.

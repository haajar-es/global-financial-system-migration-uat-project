...
- [Global Financial System Migration - UAT Project](#global-financial-system-migration---uat-project)
  ...
  - [Financial System Diagrams Process Flow](#financial-system-diagrams-process-flow)
    ...
    - [Sample List of Test Cases](#sample-list-of-test-cases)
...
This documentation is based on my personal experience and recollection of the project. It does not contain any detail proprietary information, actual data, or client-specific details. The purpose is to demonstrate the processes, experiences and lessons learned from managing a complex, multi-country UAT project.
...
- Our intensive involvement spanned a crucial **2.5-month period** covering UAT, Training, Simulations and Go-Live phases.
  
- Key aspects of my role as the focal point for the Consulting team on the project included:
  - **Directly managed and led User Acceptance Testing (UAT)** for **5 key countries** in the APAC region, verifying that financial data in **OneStream reconciled with SAP** for over **80 critical reports**.
  ...
  - **Ensured accuracy across various financial statements**, including P&L, Balance Sheet, Cash Flow Statements, Statement of Changes in Equity, Intercompany Accounting, Fixed Assets, and other key financial reports.


### High Level Overview Financial System Migration

  ![System Migration Overview](3-img/system-migration-overview.png)
  

  ![UAT Planning](3-img/uat-planning.png)
  _Image by Author_
...
To ensure the successful delivery of objectives and meet the client's strategic goal for large-scale financial transformations:
...
![Oracle HFM](3-img/oracle-process-flow.png)


### New System - OneStream XF Process Flow

![OneStream](3-img/onestream-process-flow.png)

### Sample List of Test Cases

![Schedules](3-img/schedules-finance.png)
...
### UAT Timeline
![Project Timeline](3-img/migration-project-timeline.png)
...
![UAT Process Flow](3-img/uat-process-flow.png)

### Data Validation Framework

![Data Validation Framework](3-img/data-validation-framework.png)
_Image by Author_
...
- **Solution:** Coordinated with local finance teams to adjust validation criteria and standardize data formats, reducing errors by 95%.
